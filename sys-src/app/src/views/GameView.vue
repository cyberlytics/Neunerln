...
import CardFront from '../components/game/CardFront.vue'
...
function createRoom(specialCards: string[], maxPlayers: number) {
  socket.emit(SocketRoom.onCreateRoom, userName.value, specialCards, maxPlayers)
...
function joinRoom(roomId: string) {
  ...
  socket.emit(SocketRoom.onJoinRoom, roomId, userName.value)
}
