...
if((previousDiscardCard?.number== "7") && cardnumber!='7'){
 ...
 checkforninecolor(currentRoom: Room){
  ...
  if(currentRoom.choosenColor=='Eichel'){
    wishedninecolor='https://uc108663c6c36ea8400ce631a026.previews.dropboxusercontent.com/p/thumb/AB__VdW3vwDQFqAMM89ZeSGXWnsyPcEtSRvc5TrTYGbUnvKD18mStRqWJFRvJiEDglpsJjRnsssLx2kGLMct5c57nSkdu-0Dtl_E6PhBcZs5RRNbIViB0jF664PBeWDnXtuNKzx4vhHt2KvpRlJuGb3QWeIYxaS7Su3iK2gKO7JTuhSq3qOvuM7XzuvIAGb4sAWbFXxkreodkF9VjAu2p9d8XyACPbVMY6qy7cXi9iiHGin7Ov09-OpmSHy4FXqeGgqsW4htLRj6MAj_jT-xcEnvOqnpQ3EIrgj6f7FSH_Ym_C4-UB28hWuRPvfV47bx5gd3D7eO7KfHE5AKHs3mB5Irocz0WURvvhdB5MdNOrbOkNn6GzZjIaGDu09MiJX3QyU/p.png';
    return wishedninecolor;
  }else if(currentRoom.choosenColor=='Schellen'){
    wishedninecolor='https://ucca5ced69163afe4de1051dd046.previews.dropboxusercontent.com/p/thumb/AB_QaNXdNLQUCQUfPskwp7g5jNq-dWDlggf5PiM1p2qA5ecFl36KBhQ4-_1aMaPaDM0E843MFv77OO1NvY1e7wNDy9YMHUONwMfBPGBGZKGZ38fe4X_TDtuKngMPh2BNQfkPhyztjxrOjtdnoZoi5PuGfd9CrqQj8fEvK2wxuygCCBAXWAZCPrWifB_ZRlRGXMVp08WDmwTc7P6S0x89wacNbfbbMb-PkWr1QtzOUrQWvm7Fi45SHiB3AvqNVa_D4lRGhB85oqzw-1OK9RiUAukn4dEwbJZPbumJJ9rZ_ORsOA5zNPUaRT7sGxsmS8nLVSnutcNMEVAymThtveXLFvqpzyNvdu26XtBogZ3DvgEAnJvm6FCG1uwdynRqn4VFMtA/p.png';
    return wishedninecolor;
  }else if(currentRoom.choosenColor=='Herz'){
    wishedninecolor='https://uc0edef0999f56ae148f23f11368.previews.dropboxusercontent.com/p/thumb/AB8iW2p645ehmR5fLeSgwdtVda8yOz2G_dgKXSF_1CRz7P3lKH0UzV7BuKrOGTkZOCXJMio7a2GvkYCSLaS1bvjObhdXbzUBAeUdl0csfjEjqO28r-qDWl_q9L-zPFwkpqJPYH4j_yJNbjPcMMqp3aX-_3qoSNe5qekv_3DlBo9UnCAwl1Dih6QCOufZ71pAg-9v1QhO4Gqj2LAkFARhqte4nWrt5xJ3D1-QP8szQDCRnirt50_6zx79VL5XC85Bq3pP8IembQkPlbvfE4MBXRGDhmCJo2Q4ObA3nzzneWpnIXUTrgZ850nIeHTaAmpsBVofvvcQ_PvJqXGuAnT9OzQtOKwxjHMsLmzccMqTz26k53qQtCiDl2zWpgAFstxGCRA/p.png';
    return wishedninecolor;
  }else if(currentRoom.choosenColor=='Blatt'){
    wishedninecolor='https://uc8de4228acb20a0fd867710758b.previews.dropboxusercontent.com/p/thumb/AB99YNpAVN86vmbnFk09nP9ieTy_Ao1Zkv-2GjXEkn1eAa0vbeEFt7BkL0xTluSGgbRePygG6AJVHjpiaqsS7SoXKEXi6wv6vA29UJESX9pobC516O85b9zMslEUvwHV8-AuHZTz8rTuPP3mJbBdWjLgHjR0-nMkkAWGE_-u6UZSb1Yvgo2ATfgALf0zEFEXW7_LZJTepR_uqwjz47kQyvC1Oxe-7cvTgoMSyQcVX6Qta-nh6qeD5y_J4_xeBqfrifIcX6CuIx8KJBT41xq14Gko2QGp3M6koqJ30MU4tvRVwe7whqeichEF76w5iVgOoZ5kt5NNE83M5Vtn82XRvqPwpeWXKsmg1ucvTllLCeNVupiQOFICnXewR6DZRi7AKBA/p.png';
    return wishedninecolor;
  }else{
    let lastDiscardCard = currentRoom.discardPile[currentRoom?.discardPile.length - 1];
