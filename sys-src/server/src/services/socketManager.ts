...
if((previousDiscardCard?.number== "7") && cardnumber!='7'){
 ...
 checkforninecolor(currentRoom: Room){
  ...
  if(currentRoom.choosenColor=='Eichel'){
    ...
    wishedninecolor='https://ucca5ced69163afe4de1051dd046.previews.dropboxusercontent.com/p/thumb/AB-XB0qX1d3ptX2cwd7IQhxkjZyfSRd31GfxaWxcqpRU_FNHPmKd9t0PJPwLd2bcCQYGhijrtNQGOBsFxFvesDwUIBcjpkZG5Xx41MdSfVfYi2YOzC-4-h9rPt5GtjgIJ5kcr927uyjiT19shPGORQYJS-P03-bwtMGmIlsz0dGrN0E6FwHxFMR_FpFN5L71gTfxIVf8bfI1AsFG-m8VrjfNtexeEVSrnGt4cOY5CilaGIGgADHgNN3IkNz7Nj5fmXMCsdO-YqDwwQ_fb_gDA4Q9wdUGSl2wkB1MWS-OtqkM1gtUXnJKJuqasWUhQbRxflo_yzI8ZAhiUXIEl19wDFNr/p.png?size=512x512&size_mode=1';
    return wishedninecolor;
  }else if(currentRoom.choosenColor=='Herz'){
    wishedninecolor='https://uc0edef0999f56ae148f23f11368.previews.dropboxusercontent.com/p/thumb/AB-pTV6sP3SUhJLjUpIMdKdlfd9bxXhzZD8eJxYPVfrnXACJJlhvEZ4gCkIQQzA1x3iWjxDX8ozL8Uds-YSmWTPCweXMXXId_8-DwFcDGujst84LYvZkd-JSyrWMreYrvF30HKNZSvmV3c3LU6M31-8YwVkukE767RGJS4mFYOzKMV0DfmQAhQMrrWbx_NjXVjyjK0cLJgK9aFdGTuENKZwGoqQmJ84-4lZEOaSnjDWV3KCXpFPRVb16veD2yqKpRJb8e-6kalQp10EfFg1sFzZox-vS7SPX6MCUOVK4FP_8xSWCwdthvoakPN7XyREEVUuiH338Zcma5LwnpkmuFoas/p.png?size=512x512&size_mode=1';
    return wishedninecolor;
  }else if(currentRoom.choosenColor=='Blatt'){
    wishedninecolor='https://uc8de4228acb20a0fd867710758b.previews.dropboxusercontent.com/p/thumb/AB-vNTYeJI47Mk1AcukuFbk_r0YluDRyuTuyhauE2skIlKhPYVHGhP5s_iu6b9NasS_Avu2rUhpJVBexFLLDMONPj_iO8cRJM_8kwkMSQe74dg_bCDHw3YS-1UvLi2jth_Ae7noWV9qvvS7EExWgTa0Ay1JpNODd8tpz0f5GgM5ktueRj23lMkSiWpTSjC8o1RDln0Y7wR0kinM1JOQAbOKMyM-Aa58Q-MNuSF3fhTxHlM7jpbW_g-B0MUveZuw69yMSBz7lbav-GDqpvlS7yI-8tviqwAVyIn1B3QhgmDTqNogP1DXmiolJwcFq-2kvtRyL8LLhUlqJ4kOHzyQozzWB/p.png?size=512x512&size_mode=1';
    return wishedninecolor;
  }else{
    let lastDiscardCard = currentRoom.discardPile[currentRoom?.discardPile.length - 1];
